...
class build_resnet_block(nn.Module):
    ...
    """
    def __init__(self, channels, layers=2, do_batch_norm=True): #do_batch_normをTrueに、layerを4に
...
class upsample_conv2d_and_predict_flow(nn.Module):
    ...
    """
    def __init__(self, in_channels, out_channels, ksize=3, do_batch_norm=True): #do_batch_norm=False
...
def general_conv2d(in_channels,out_channels, ksize=3, strides=2, padding=1, do_batch_norm=True, activation='relu'): #do_batch_norm
    """
